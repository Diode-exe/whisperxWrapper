"""Static constants and lookup tables for WhisperX wrapper.

These values never change at runtime and are safe to import without
...
# Human-friendly language names (in same order as shorthand)
SUPPORTED_LANGUAGES_LONGHAND = [
...
# Longhand → shorthand language code mapping
LONG_TO_SHORT = {
    ...
    "Icelandic": "is", "Italian": "it", "Japanese": "ja", "Javanese": "jw",
    "Georgian": "ka", "Kazakh": "kk", "Khmer": "km", "Kannada": "kn",
    "Korean": "ko", "Latin": "la", "Luxembourgish": "lb", "Lingala": "ln",
    "Lao": "lo", "Lithuanian": "lt", "Latvian": "lv", "Malagasy": "mg",
    "Maori": "mi", "Macedonian": "mk", "Malayalam": "ml", "Mongolian": "mn",
    "Marathi": "mr", "Malay": "ms", "Maltese": "mt", "Myanmar": "my",
    "Nepali": "ne", "Dutch": "nl", "Nynorsk": "nn", "Norwegian": "no",
    "Occitan": "oc", "Punjabi": "pa", "Polish": "pl", "Pashto": "ps",
    ...
    "Sundanese": "su", "Swedish": "sv", "Swahili": "sw", "Tamil": "ta",
    "Telugu": "te", "Tajik": "tg", "Thai": "th", "Turkmen": "tk",
    "Tagalog": "tl", "Turkish": "tr", "Tatar": "tt", "Ukrainian": "uk",
    "Urdu": "ur", "Uzbek": "uz", "Vietnamese": "vi", "Yoruba": "yo",
    "Chinese": "zh",
}
